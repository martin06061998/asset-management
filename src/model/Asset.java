...
public class Asset implements Serializable {
    ...
    public Asset(String assetID, String name, String color, long price, double weight, int quantity, int currentQty) {
        ...
        if (currentQty < 0) {
            throw new IllegalArgumentException("current quantity should not be zero or negagive");
        }
        if (currentQty > quantity) {
            throw new IllegalArgumentException("current quantity should not be greater than quantity");
        }
    ...
    public JsonNode toJsonNode() {
        ...
        answer.put("qty", String.valueOf(quantity));
        answer.put("currentqty", String.valueOf(curQty));
        return answer;
    }
}
